...
public class ChiefCookDashboardFormController {
    ...
    public void btnManageSupplierDetailsOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.MANAGESUPPLIERDETAILSWITHCHEIFCOOK,pane);
    }

    public void btnManageStockOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.MANAGESTOCKWITHCHEIFCOOK,pane);

    }


    public void btnManageRecipeOnAction(ActionEvent actionEvent) throws IOException {
