...
public class CashierLoginFormController {
    ...
    public void btnLoginOnAction(ActionEvent actionEvent) throws IOException {
        ...
        try {
            ...
            ResultSet rs = connection.createStatement().executeQuery("SELECT * FROM cashier");
            while (rs.next()){
    ...
    public void signupBtnOnClickAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.CASHIERSIGNUP,pane);

    }

    public void txtForgotPasswordOnAction(MouseEvent mouseEvent) throws IOException {
        Navigation.navigate(Routes.CASHIERFORGOTPASSWORD,pane);
    }
    ...
    public void whatsappImgOnClicAction(MouseEvent mouseEvent) throws URISyntaxException, IOException {
